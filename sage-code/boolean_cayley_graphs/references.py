...
\\newblock Spectral analysis of {Boolean} functions as a graph eigenvalue problem.
\\newblock {\\em IEEE Transactions on Computers}, 48(3):345--351, (1999).
""")

bibitem["BerCV01"] = ("""
A.~Bernasconi, B.~Codenotti, and J.~M. VanderKam.
\\newblock A characterization of bent functions in terms of strongly regular graphs.
\\newblock {\\em IEEE Transactions on Computers}, 50(9):984--985, (2001).
""")

bibitem["Bos63"] = ("""
R.~C. Bose.
\\newblock Strongly regular graphs, partial geometries and partially balanced designs.
...
\\newblock Phd thesis, Katholieke Universiteit Leuven, Leuven-Heverlee, Belgium,
  (2006).
""")
...
bibitem["DinD15class"] = ("""
K.~Ding and C.~Ding.
\\newblock A class of two-weight and three-weight codes and their applications
  in secret sharing.
\\newblock {\\em IEEE Transactions on Information Theory}, 61(11):5835--5842,
  (2015).
""")

bibitem["FeuSSW2013"] = ("""
T.~Feulner, L.~Sok, P.~Sol{\\'e}, and A.~Wassermann.
\\newblock Towards the classification of self-dual bent functions in eight variables.
...
bibitem["Lan10psf"] = ("""
P.~Langevin.
\\newblock Classification of partial spread functions in eight variables, (2010).
\\newblock \url{http://langevin.univ-tln.fr/project/spread/psp.html} Last
  accessed 9 May 2017.
""")
...
\\newblock Submitted October 2016 to Journal of Algebra Combinatorics Discrete
  Structures and Applications, accepted April 2017. Preprint: arXiv:1504.02827
  [math.CO].
""")
...
\\newblock \url{https://github.com/penguian/Boolean-Cayley-graphs} GitHub
  repository. Last accessed 9 May 2017.
""")
...
\\newblock \url{http://tinyurl.com/Boolean-Cayley-graphs} SageMathCloud public
  folder. Last accessed 9 May 2017.
""")
...
\\newblock {\\em Journal of Combinatorial Theory, Series A}, 20(3):300--305, (1976).
""")

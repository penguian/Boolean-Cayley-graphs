...
\date{For Short Communications Satellite 2022}
...
\begin{frame}
\frametitle{ET classes $[f_{6,1}]$ and $[f_{6,2}]$}
\begin{figure}
\centering
\begin{minipage}{.48\textwidth}
  \centering
...
\begin{frame}[fragile]
\frametitle{ET classes $[f_{8,5}]$ and $[f_{8,6}]$ are the same}
\begin{theorem}
Functions $f_{8,5}$ and $f_{8,6}$ are linearly equivalent and therefore   
Braeken's ET classes $[f_{8,5}]$ and $[f_{8,6}]$ are the same class.
\end{theorem}
...
\begin{frame}
\frametitle{ET classes $[f_{8,1}]$ and $[f_{8,2}]$}
\begin{figure}
\centering
\begin{minipage}{.48\textwidth}
  \centering
...
\end{minipage}
\end{figure}
Graphs for class 0 of $[f_{8,1}]$ and class 0 of $[f_{8,2}]$ are isomorphic.
\end{frame}
\begin{frame}
\frametitle{ET classes $[f_{8,3}]$ and $[f_{8,4}]$}
\begin{figure}
\centering
\begin{minipage}{.48\textwidth}
  \centering
...
\begin{frame}
\frametitle{ET classes $[f_{8,7}]$ and $[f_{8,8}]$}
\begin{figure}
\centering
\begin{minipage}{.48\textwidth}
  \centering
...
\end{frame}
\begin{frame}
\frametitle{ET classes $[f_{8,9}]$ and $[f_{8,10}]$}
\begin{figure}
\centering
\begin{minipage}{.48\textwidth}
  \centering
...
Preprint: Paul Leopardi, Classifying bent functions by their Cayley graphs,  arXiv:1705.04507 [math.CO]. Revised, December, 2018.
...
Spectral analysis of {Boolean} functions as a graph eigenvalue
  problem.
...
{\em Designs, Codes and Cryptography}, 59(1-3):193--205, (2011).
 \item
O.~S. Rothaus.
On ``bent'' functions.

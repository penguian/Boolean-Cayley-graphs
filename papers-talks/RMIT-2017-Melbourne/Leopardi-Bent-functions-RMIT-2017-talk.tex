...
\includegraphics[width=.9\linewidth]{../matrix_plot/cast_128_1_1_weight_class_matrix.png}
  \captionof{figure}{$[cast128_{1,0}]$: weight classes ~~~~~~ ~~~~~~~~}
  \label{fig:cast128_1_1_weight_class_matrix}
\end{minipage}
\begin{minipage}{.48\textwidth}
  \centering
\includegraphics[width=.9\linewidth]{../matrix_plot/cast_128_1_1_bent_cayley_graph_index_matrix.png}
...
\item
In $2m$ dimensions,
which ET classes contain the maximum number, $4^m$, of different EC classes?
\item

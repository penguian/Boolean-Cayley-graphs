...
\title[Boolean-Cayley-graphs: exploring Bent functions and their Cayley graphs]{Boolean-Cayley-graphs: \\
Using Sage and Python software to explore Boolean functions, their Cayley graphs and associated structures}
\author{Paul Leopardi}

\date{For Hadamard 2025}
...
\begin{frame}[fragile]
\frametitle{Demo of Boolean-Cayley-graphs}
...
\begin{minipage}{.48\textwidth}
  ...
  \label{fig:c6_2_general_linear_class_index_matrix}
\end{minipage}
\end{figure}
